...
const footer = () => {
    return (
        <div className="bg-footer" id="first-section">
            <div className="mx-auto max-w-2xl pt-6 pb-16 px-4 sm:px-6 lg:max-w-7xl lg:px-8">
  ...
  <div className="Footerbox Footerbox1">
    <span className="Footericon"
      ><svg viewBox="0 0 30 30" xmlns="http://www.w3.org/2000/svg" className="Footersvg">
        <path
  ...
  <div className="Footerbox Footerbox4"></div>
</div>
                    ...
                    <div className='col-span-4'>
                        <h3 className='text-black text-xl font-semibold mb-6'>Stay up to date</h3>
            ...
            <div className='pb-24 px-4'>
                <h3 className='text-center text-black'>@2024 - All Rights Reserved by @CodeWithSabuj</h3>
            </div>
