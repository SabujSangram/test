            ...
            <div className="relative px-6 lg:px-8">
                <div className="mx-auto max-w-5xl pt-16 sm:pt-40 sm:pb-24">
                    <div className="text-center">
                        <h1 className="text-3xl sm:text-5xl font-bold tracking-tight text-gray-900 md:4px">
                            Advance your Digital Marketing <br /> skills with our courses
                        </h1>
                        ...
                        <div className="mt-10 flex items-center justify-center gap-x-6">
                            ...
                            <div className='bannerBorder sm:pl-8'>
                                <div className='flex justify-center sm:justify-start'>
                                    <h3 className='text-2xl font-semibold mr-2'>4.2</h3>
                                    <img src={'/assets/banner/Stars.svg'} alt="stars-icon" />
                                </div>
                                <div>
                                    <h3 className='text-sm'>Rated by 12k Professionals and Learners</h3>
                                </div>
                            </div>
                        </div>
                    </div>
