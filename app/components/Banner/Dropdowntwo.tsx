...
const Hour: Hourtype[] = [
  { name: '1 days in a Week' },
  { name: '2 days in a Week' },
  { name: '4 days in a Week' },
  { name: '7 days in a Week' },
]
...
const Dropdown = () => {
  ...
  return (
    <div className="w-full">
      ...
      <h3 className='text-lg text-lightgrey'>How much time you are going to invest ?</h3>
